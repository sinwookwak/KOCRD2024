...
<<<<<<< Updated upstream:.venv/Lib/site-packages/sentence_transformers/fit_mixin.py
...
=======
    def __init__(self, evaluator: SentenceEvaluator) -> None:
        super().__init__()
        self.evaluator = evaluator
>>>>>>> Stashed changes:tool/Sentence_Transformer/sentence_transformers/fit_mixin.py
