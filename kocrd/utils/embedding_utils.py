...
def generate_document_type_embeddings(settings_manager, local_model_path: Optional[str] = None) -> Dict[str, List[float]]:
    """문서 유형별 임베딩을 생성합니다."""
    try:
        model = load_embedding_model(local_model_path=local_model_path)
