...
<<<<<<< Updated upstream:.venv/Lib/site-packages/sentence_transformers/model_card.py
...
>>>>>>> Stashed changes:tool/Sentence_Transformer/sentence_transformers/model_card.py
