...
<<<<<<< Updated upstream:.venv/Lib/site-packages/sentence_transformers/training_args.py
from typing import Optional, Union
=======
>>>>>>> Stashed changes:tool/Sentence_Transformer/sentence_transformers/training_args.py
